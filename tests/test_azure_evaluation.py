...
class AzureEvaluationHelpersTests(unittest.TestCase):
    ...
    def test_notebook_declares_azure_dependencies_and_full_run_guard(self):
        ...
        self.assertIn('"evaluate"', notebook)
        self.assertIn('"transformers"', notebook)
        self.assertIn('"absl-py"', notebook)
        self.assertIn('"nltk"', notebook)
        self.assertIn('"rouge-score"', notebook)
        self.assertIn('"scikit-learn"', notebook)
